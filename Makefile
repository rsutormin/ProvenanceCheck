SERVICE = provenancecheck
SERVICE_CAPS = ProvenanceCheck
SPEC_FILE = ProvenanceCheck.spec
URL = https://kbase.us/services/provenancecheck
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
compile:
	kb-sdk compile $(SPEC_FILE) \
		--out $(LIB_DIR) \
		--plclname $(SERVICE_CAPS)::$(SERVICE_CAPS)SyncClient \
