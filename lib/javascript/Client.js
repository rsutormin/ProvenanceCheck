...
function ProvenanceCheck(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_service_props = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ProvenanceCheck.get_service_props",
            [], 1, _callback, _errorCallback);
    };
 
     this.hello_string = function (name, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ProvenanceCheck.hello_string",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ProvenanceCheck.status",
            [], 1, _callback, _errorCallback);
    };
